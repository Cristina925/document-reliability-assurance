 ...
 * ║  src/claim-extraction/segment-content.ts exactly as it existed when      ║
 ...
 * ║  to the live segment-content.ts. Exports are suffixed `PreEng023` to     ║
...
function splitLineIntoSentences(
  ...
  for (let i = 0; i < line.length; i++) {
    ...
    if (ch === "!" || ch === "?") {
      ...
      // ch === "."
      isBoundary = isSentenceBoundaryPeriod(line, i);
    }
 ...
 */
export function segmentContentPreEng023(content: string): ContentSegment[] {

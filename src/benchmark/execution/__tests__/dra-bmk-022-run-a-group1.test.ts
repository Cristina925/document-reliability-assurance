/**
 * DRA-BMK-022 — Run A, Group 1 (DRA-DOC-0001..0011)
...
import { runGroupAndSummarize, writeJson, GROUP_1_IDS, RUN_A_GROUP_PATHS } from "./dra-bmk-022-run-helpers.js";
...
describe("DRA-BMK-022 — Run A, Group 1 (DRA-DOC-0001..0011)", () => {

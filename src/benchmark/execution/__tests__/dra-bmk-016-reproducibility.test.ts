/**
 * DRA-BMK-016 — Part 9 (Focused): Reproducibility Controls
 *
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  REPRODUCIBILITY TEST — DRA-BMK-016                                      ║
 * ║                                                                          ║
 * ║  Focused verification of reproducibility controls against the initial    ║
 * ║  six-document corpus (synchronous — no live network).                    ║
 * ║                                                                          ║
 * ║  Full sixteen-document Run A / Run B comparison is covered in            ║
 * ║  dra-bmk-016-evaluator-run.test.ts (live network, all 16 docs).         ║
 * ║                                                                          ║
 * ║  Run A fixed timestamp: 2026-08-07T17:30:00.000Z                        ║
 * ║  Run B fixed timestamp: 2026-08-07T17:45:00.000Z                        ║
 * ║                                                                          ║
...
const FIXED_TS_A = "2026-08-07T17:30:00.000Z";
const FIXED_TS_B = "2026-08-07T17:45:00.000Z";
const FIXED_RUN_ID = "bmk-016-repro";
...
describe("DRA-BMK-016 — Reproducibility (6-doc sync): decision stability", () => {
...
describe("DRA-BMK-016 — Reproducibility (6-doc sync): proof-receipt digest", () => {
...
describe("DRA-BMK-016 — Reproducibility (6-doc sync): issue counts and classes", () => {

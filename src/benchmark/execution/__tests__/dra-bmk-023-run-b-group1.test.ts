/**
 * DRA-BMK-023 — Run B, Group 1 (DRA-DOC-0001..0011)
...
import { runGroupAndSummarize, writeJson, GROUP_1_IDS, RUN_B_GROUP_PATHS } from "./dra-bmk-023-run-helpers.js";
...
describe("DRA-BMK-023 — Run B, Group 1 (DRA-DOC-0001..0011)", () => {

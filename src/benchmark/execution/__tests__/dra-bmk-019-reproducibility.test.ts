/**
 * DRA-BMK-019 — Part 7 (Focused): Reproducibility Controls
 *
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  REPRODUCIBILITY TEST — DRA-BMK-019                                      ║
 * ║                                                                          ║
 * ║  Focused verification of reproducibility controls against the initial    ║
 * ║  six-document corpus (synchronous — no live network).                    ║
 * ║                                                                          ║
 * ║  Full nineteen-document Run A / Run B comparison is covered in           ║
 * ║  dra-bmk-019-evaluator-run.test.ts (live network, all 19 docs).         ║
 * ║                                                                          ║
 * ║  Run A fixed timestamp: 2026-08-09T10:30:00.000Z                        ║
 * ║  Run B fixed timestamp: 2026-08-09T10:45:00.000Z                        ║
 * ║                                                                          ║
...
const FIXED_TS_A = "2026-08-09T10:30:00.000Z";
const FIXED_TS_B = "2026-08-09T10:45:00.000Z";
const FIXED_RUN_ID = "bmk-019-repro";
...
describe("DRA-BMK-019 — Reproducibility (6-doc sync): decision stability", () => {
...
describe("DRA-BMK-019 — Reproducibility (6-doc sync): proof-receipt digest", () => {
...
describe("DRA-BMK-019 — Reproducibility (6-doc sync): issue counts and classes", () => {

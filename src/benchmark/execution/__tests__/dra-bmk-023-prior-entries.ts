/**
 * DRA-BMK-023 test support — DRA-DOC-0007..0022 CorpusDocumentInput entries.
 *
 * Extracted verbatim from dra-bmk-022-twentytwo-document-checkpoint.test.ts
 * (already proven, in that checkpoint, to reproduce the exact admission-time
 * 22-document manifest digest dc14706ac99fd3e64fe98b9bb1ecc42c42e434422408
 * bfa13cd301fcd15aa4d8). Reused here unmodified so that BMK-023's lock-inputs
 * check can (a) confirm the 22 pre-existing entries are unchanged since
 * DRA-BMK-022, and (b) add ENTRY_0023 to compute the new 23-document
 * manifest digest.
 */

import { CorpusDocumentInput } from "../../corpus/schema.js";
...
export const CORPUS_VERSION = "DRA-CORPUS-1.0.0";
export const ADMISSION_MANIFEST_DIGEST_22 = "dc14706ac99fd3e64fe98b9bb1ecc42c42e434422408bfa13cd301fcd15aa4d8";
...
export const PRIOR_CORPUS_ENTRIES: CorpusDocumentInput[] = [

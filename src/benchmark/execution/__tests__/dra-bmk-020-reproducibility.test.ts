/**
 * DRA-BMK-020 — Part 7 (Focused): Reproducibility Controls
 *
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  REPRODUCIBILITY TEST — DRA-BMK-020                                      ║
 * ║                                                                          ║
 * ║  Focused verification of reproducibility controls against the initial    ║
 * ║  six-document corpus (synchronous — no live network).                    ║
 * ║                                                                          ║
 * ║  Full twenty-document Run A / Run B comparison is covered in             ║
 * ║  dra-bmk-020-evaluator-run.test.ts (live network, all 20 docs).         ║
 * ║                                                                          ║
 * ║  Run A fixed timestamp: 2026-08-09T16:30:00.000Z                        ║
 * ║  Run B fixed timestamp: 2026-08-09T16:45:00.000Z                        ║
 * ║                                                                          ║
...
const FIXED_TS_A = "2026-08-09T16:30:00.000Z";
const FIXED_TS_B = "2026-08-09T16:45:00.000Z";
const FIXED_RUN_ID = "bmk-020-repro";
...
describe("DRA-BMK-020 — Reproducibility (6-doc sync): decision stability", () => {
...
describe("DRA-BMK-020 — Reproducibility (6-doc sync): proof-receipt digest", () => {
...
describe("DRA-BMK-020 — Reproducibility (6-doc sync): issue counts and classes", () => {

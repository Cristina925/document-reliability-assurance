/**
 * DRA-BMK-022 — Run B, Group 3 (DRA-DOC-0020..0022)
...
import { runGroupAndSummarize, writeJson, GROUP_3_IDS, RUN_B_GROUP_PATHS } from "./dra-bmk-022-run-helpers.js";
...
describe("DRA-BMK-022 — Run B, Group 3 (DRA-DOC-0020..0022)", () => {

/**
 * DRA-BMK-015 — Part 9 (Focused): Reproducibility Controls
 *
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  REPRODUCIBILITY TEST — DRA-BMK-015                                      ║
 * ║                                                                          ║
 * ║  Focused verification of reproducibility controls against the initial    ║
 * ║  six-document corpus (synchronous — no live network).                    ║
 * ║                                                                          ║
 * ║  Full fifteen-document Run A / Run B comparison is covered in            ║
 * ║  dra-bmk-015-evaluator-run.test.ts (live network, all 15 docs).         ║
 * ║                                                                          ║
 * ║  Run A fixed timestamp: 2026-08-06T23:30:00.000Z                        ║
 * ║  Run B fixed timestamp: 2026-08-06T23:45:00.000Z                        ║
 * ║                                                                          ║
...
const FIXED_TS_B = "2026-08-06T23:45:00.000Z";
const FIXED_RUN_ID = "bmk-015-repro";
...
describe("DRA-BMK-015 — Reproducibility (6-doc sync): decision stability", () => {
...
describe("DRA-BMK-015 — Reproducibility (6-doc sync): proof-receipt digest", () => {
...
describe("DRA-BMK-015 — Reproducibility (6-doc sync): issue counts and classes", () => {

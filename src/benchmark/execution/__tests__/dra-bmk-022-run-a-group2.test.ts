/**
 * DRA-BMK-022 — Run A, Group 2 (DRA-DOC-0012..0019)
...
import { runGroupAndSummarize, writeJson, GROUP_2_IDS, RUN_A_GROUP_PATHS } from "./dra-bmk-022-run-helpers.js";
...
describe("DRA-BMK-022 — Run A, Group 2 (DRA-DOC-0012..0019)", () => {

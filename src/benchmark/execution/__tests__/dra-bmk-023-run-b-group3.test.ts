/**
 * DRA-BMK-023 — Run B, Group 3 (DRA-DOC-0020..0022)
...
import { runGroupAndSummarize, writeJson, GROUP_3_IDS, RUN_B_GROUP_PATHS } from "./dra-bmk-023-run-helpers.js";
...
beforeAll(async () => {
  try {
    ...
    await writeJson(RUN_B_GROUP_PATHS.g3, { records });
  } catch (err) {
    setupError = String(err);
  }
}, 280_000);

describe("DRA-BMK-023 — Run B, Group 3 (DRA-DOC-0020..0022)", () => {

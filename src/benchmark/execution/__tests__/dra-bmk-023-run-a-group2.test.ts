/**
 * DRA-BMK-023 — Run A, Group 2 (DRA-DOC-0012..0019)
...
import { runGroupAndSummarize, writeJson, GROUP_2_IDS, RUN_A_GROUP_PATHS } from "./dra-bmk-023-run-helpers.js";
...
beforeAll(async () => {
  try {
    ...
    await writeJson(RUN_A_GROUP_PATHS.g2, { records });
  } catch (err) {
    setupError = String(err);
  }
}, 280_000);

describe("DRA-BMK-023 — Run A, Group 2 (DRA-DOC-0012..0019)", () => {

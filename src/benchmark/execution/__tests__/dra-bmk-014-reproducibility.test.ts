/**
 * DRA-BMK-014 — Part 9 (Focused): Reproducibility Controls
 *
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  REPRODUCIBILITY TEST — DRA-BMK-014                                      ║
 * ║                                                                          ║
 * ║  Focused verification of reproducibility controls against the initial    ║
 * ║  six-document corpus (synchronous — no live network).                    ║
 * ║                                                                          ║
 * ║  Full fourteen-document Run A / Run B comparison is covered in           ║
 * ║  dra-bmk-014-evaluator-run.test.ts (live network, all 14 docs).         ║
 * ║                                                                          ║
 * ║  Run A fixed timestamp: 2026-08-06T22:00:00.000Z                        ║
 * ║  Run B fixed timestamp: 2026-08-06T22:30:00.000Z                        ║
 * ║                                                                          ║
...
const FIXED_TS_A = "2026-08-06T22:00:00.000Z";
const FIXED_TS_B = "2026-08-06T22:30:00.000Z";
const FIXED_RUN_ID = "bmk-014-repro";
...
describe("DRA-BMK-014 — Reproducibility (6-doc sync): decision stability", () => {
...
describe("DRA-BMK-014 — Reproducibility (6-doc sync): proof-receipt digest", () => {
...
describe("DRA-BMK-014 — Reproducibility (6-doc sync): issue counts and classes", () => {

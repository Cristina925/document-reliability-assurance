/**
 * DRA-BMK-017 — Part 9 (Focused): Reproducibility Controls
 *
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  REPRODUCIBILITY TEST — DRA-BMK-017                                      ║
 * ║                                                                          ║
 ...
 * ║                                                                          ║
 * ║  Run A fixed timestamp: 2026-08-07T19:30:00.000Z                        ║
 * ║  Run B fixed timestamp: 2026-08-07T19:45:00.000Z                        ║
 * ║                                                                          ║
...
const FIXED_TS_A = "2026-08-07T19:30:00.000Z";
const FIXED_TS_B = "2026-08-07T19:45:00.000Z";
const FIXED_RUN_ID = "bmk-017-repro";
...
describe("DRA-BMK-017 — Reproducibility (6-doc sync): decision stability", () => {
...
describe("DRA-BMK-017 — Reproducibility (6-doc sync): proof-receipt digest", () => {
...
describe("DRA-BMK-017 — Reproducibility (6-doc sync): issue counts and classes", () => {

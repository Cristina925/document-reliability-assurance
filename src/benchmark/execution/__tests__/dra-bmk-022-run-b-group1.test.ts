/**
 * DRA-BMK-022 — Run B, Group 1 (DRA-DOC-0001..0011)
...
import { runGroupAndSummarize, writeJson, GROUP_1_IDS, RUN_B_GROUP_PATHS } from "./dra-bmk-022-run-helpers.js";
...
beforeAll(async () => {
  try {
    ...
    await writeJson(RUN_B_GROUP_PATHS.g1, { records });
  } catch (err) {
    setupError = String(err);
  }
}, 280_000);

describe("DRA-BMK-022 — Run B, Group 1 (DRA-DOC-0001..0011)", () => {
